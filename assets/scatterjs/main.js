                ...
                function doitx(param) {
                    ...
                    */
                    ...
                    function dotransaction() {
                        ...
                        var eos_memo = "BNG is a Prove of Work coin on EOS Blockchain";
                    ...
                    function dotransaction_bundle() {
                        ...
                        eosobject.getTableRows({
                            ...
                            "table": "accounts"
                                ...
                                BNG_mining_supply = value.rows[0].balance;
                                BNG_mining_supply = parseFloat(BNG_mining_supply);
                        ...
                        var miningRate1 = (BNG_mining_supply / 40000);
                    ...
                    // Initialize Ram for bitnetworker token contract to be able to mine ------------------------
                    function doinit() {
                    ...
                    function get_balance() {
                        ...
                        */
                        ...
                        eosobject.getTableRows({
                            ...
                            try {
                                var BNGUserBalance = value.rows[0].balance;
                                BNGUserBalance = parseFloat(BNGUserBalance);
                                

                                var last = value.rows[0].balance;
                                last = last.replace("BNG", "");
                                ...
                                document.getElementById('dotransaction_bundle').style.visibility = "visible";
                                    ...
                                    var mining_rate = (BNG_mining_supply / 40000);
                                    mining_rate = parseFloat(mining_rate).toFixed(8);


                                    document.getElementById('BNGMiningRate').innerHTML = "<span class='bold' style='font-size:14px;'>Mining Reward per Transaction: <span style='color:#00bb00'>" + mining_rate + "</span> BNG</span>";
                            ...
                            //document.getElementById('balance').innerHTML = "Your Balance: <span class='bold'>" + last + "</span>";
                            if (document.getElementById('BNG_balance')) {
                                document.getElementById('BNG_balance').innerHTML = "<span class='bold'>" + last + " BNG</span>";
                            }
